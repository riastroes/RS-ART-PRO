class App{
  ...
  void draw(){
    ...
    for(Rect r : Arect){
      ...
      if((d % 2)== 0){
          r.grid.disorderByVector(r.grid.pos[100 + 5],-25);
          r.grid.disorderByVector(r.grid.pos[200 + 5],25);
          r.grid.disorderByVector(r.grid.pos[300 + 5],-25);
          r.grid.disorderByVector(r.grid.pos[400 + 5],25);
      }
      else{
          r.grid.disorderByVector(r.grid.pos[100 + 5],-25);
          r.grid.disorderByVector(r.grid.pos[200 + 5],-25);
