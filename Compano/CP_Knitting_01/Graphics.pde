class Graphics{
  ...
  //    this.p[0].x = this.pos.x;
  //    this.p[0].y = this.pos.y;
  //    this.p[1].x = this.pos.x + (this.gwidth/3);
  //    this.p[1].y = this.pos.y;
  //    this.p[2].x = this.pos.x + (this.gwidth/3*2);
  //    this.p[2].y = this.pos.y;
  //    this.p[3].x = this.pos.x + this.gwidth;
  //    this.p[3].y = this.pos.y;
      
  //    this.p[4].x = this.pos.x;
  //    this.p[4].y = this.pos.y + (this.gheight/4);
  //    this.p[5].x = this.pos.x + (this.gwidth/3);
  //    this.p[5].y = this.pos.y + (this.gheight/4);
  //    this.p[6].x = this.pos.x + (this.gwidth/3*2);
  //    this.p[6].y = this.pos.y + (this.gheight/4);
  //    this.p[7].x = this.pos.x + this.gwidth;
  //    this.p[7].y = this.pos.y + (this.gheight/4);
      
  //    this.p[8].x = this.pos.x;
  //    this.p[8].y = this.pos.y + (this.gheight/2);
  //    this.p[9].x = this.pos.x + (this.gwidth/3);
  //    this.p[9].y = this.pos.y + (this.gheight/2);
  //    this.p[10].x = this.pos.x + (this.gwidth/3*2);
  //    this.p[10].y = this.pos.y + (this.gheight/2);
  //    this.p[11].x = this.pos.x + this.gwidth;
  //    this.p[11].y = this.pos.y + (this.gheight/2);
      
  //    this.p[12].x = this.pos.x;
  //    this.p[12].y = this.pos.y + (this.gheight/4*3);
  //    this.p[13].x = this.pos.x + (this.gwidth/3);
  //    this.p[13].y = this.pos.y + (this.gheight/4*3);
  //    this.p[14].x = this.pos.x + (this.gwidth/3*2);
  //    this.p[14].y = this.pos.y + (this.gheight/4*3);
  //    this.p[15].x = this.pos.x + this.gwidth;
  //    this.p[15].y = this.pos.y + (this.gheight/4*3);
      
  //    this.p[16].x = this.pos.x;
  //    this.p[16].y = this.pos.y + this.gheight;
  //    this.p[17].x = this.pos.x + (this.gwidth/3);
  //    this.p[17].y = this.pos.y + this.gheight;
      //this.p[18].x = this.pos.x + (this.gwidth/3*2);
      //this.p[18].y = this.pos.y + this.gheight;
      //this.p[19].x = this.pos.x + this.gwidth;
      //this.p[19].y = this.pos.y + this.gheight;
//    }
//  }
