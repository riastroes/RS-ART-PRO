...
void setup(){
  ...
  background(255);
  knitting = new GenKnitting(new PVector(25,25,0),11);
  knitting.createRow(0, "aaaaaaaaab"); //<>//
  knitting.createRow(1, "dccccccccc");
  knitting.createRow(2, "effffffffg");
  knitting.createRow(3, "dccccccccc");
  knitting.createRow(4, "effffffffg");
  knitting.createRow(5, "dccccccccc");
  knitting.createRow(6, "effffffffg");
  knitting.createRow(7, "dccccccccc");
  knitting.createRow(8, "effffffffg");
  knitting.createRow(9, "dccccccccc");
  knitting.createRow(10, "hiiiiiiiij");
