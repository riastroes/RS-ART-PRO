...
void setup(){
  size(1000,1000);
  background(255);
  grid = new Grid(new PVector(0,0),1000,1000,50,50);  //scale 5
  grid.show();
  
  background(255);
  knitting = new GenKnitting(new PVector(5,5,0),5);
  knitting.createRow(0, "1111112"); //<>//
  knitting.createRow(1, "4333333");
  knitting.createRow(2, "5555556");
  knitting.createRow(3, "4333333");
  knitting.createRow(4, "7888889");
