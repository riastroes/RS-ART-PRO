  ...
  void create(char type){
     switch(type){
       ...
       case '1': {                         //"rsetup" opzetsteek naar rechts
        ...
        this.stitch[1] = new PVector(2,0,1);
        this.stitch[2] = new PVector(4,2,3);
        this.stitch[3] = new PVector(4,3,3);
        this.stitch[4] = new PVector(3,4,1);   
        this.stitch[5] = new PVector(2,4,1);
        this.stitch[6] = new PVector(1,3,1);
        this.stitch[7] = new PVector(1,2,3);
      ...
      case '2':    {                      //"lastrsetup":{          //laatste opzetsteek naar rechts
        ...
        this.stitch[7] = new PVector(1,2,3);
        this.stitch[8] = new PVector(3,0,3);
        this.stitch[9] = new PVector(5,0,1);
        this.stitch[10] = new PVector(5,1,1);
        this.stitch[11] = new PVector(4,1,1);
         break;
      }
      case '3':    {                      //links
       ...
       case '4':    {                      //eerste links
        ...
        this.stitch[11] = new PVector(-3,0,1);  
        this.stitch[12] = new PVector(-4,0,1);  
        this.stitch[13] = new PVector(-4,4,1);
      ...
      case '6':     {                     //laatste rechts
        ...
        this.stitch[14] = new PVector(5,4,1);
        this.stitch[15] = new PVector(4,4,1);
        break;
      }
      
       case '7':     {                     //eerste afhechting  
        this.max = 8;
        this.stitch = new PVector[this.max];
        this.stitch[0] = new PVector(0,0,1);
        this.stitch[1] = new PVector(1,0,1);
        this.stitch[2] = new PVector(2,1,1);
        this.stitch[3] = new PVector(2,2,3);
        this.stitch[4] = new PVector(1,3,3);
        this.stitch[5] = new PVector(0,3,1);
        this.stitch[6] = new PVector(0,4,1);
        this.stitch[7] = new PVector(3,4,1);
      ...
      this.max = 10;
        ...
        this.stitch[0] = new PVector(0,0,1);
        this.stitch[1] = new PVector(1,0,1);
        this.stitch[2] = new PVector(3,-2,3);
        this.stitch[3] = new PVector(3,-3,3);
        this.stitch[4] = new PVector(2,-4,1);
        this.stitch[5] = new PVector(1,-4,1);
        this.stitch[6] = new PVector(0,-3,1);
        this.stitch[7] = new PVector(0,-2,3);
        this.stitch[8] = new PVector(2,0,3);
        this.stitch[9] = new PVector(4,0,1);
       
         break;
      }
      case '9':       {  
        this.max = 16;                       //laatste afhechting
       this.stitch = new PVector[this.max];
        this.stitch[0] = new PVector(0,0,1);
        this.stitch[1] = new PVector(1,0,1);
        this.stitch[2] = new PVector(3,-2,3);
        ...
        this.stitch[8] = new PVector(2,0,3);
        this.stitch[9] = new PVector(5,0,1);
        this.stitch[10] = new PVector(6,-1,3);
        this.stitch[11] = new PVector(6,-4,1);
        this.stitch[12] = new PVector(5,-4,1);
        this.stitch[13] = new PVector(4,-3,1);
        this.stitch[14] = new PVector(4,-2,3);
        this.stitch[15] = new PVector(6,0,3);
