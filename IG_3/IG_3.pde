...
void oscEvent(OscMessage oscmsg) {
 ...
 if(oscmsg.checkAddrPattern("/wek/outputs")){
      ...
      r = constrain(int(map(oscmsg.get(0).floatValue(),0,1, 0,150)),0,150);
      g = constrain(int(map(oscmsg.get(1).floatValue(),0,1,0,150)),0,150);
      b = constrain(int(map(oscmsg.get(2).floatValue(),0,1,0,150)),0,150);
