class BezierCircle{
  ...
  BezierCircle(float radius){
   ...
   this.end = new PVector(0, -this.radius*2);
...
void create(){
  //this.begin = posOnCircle(new PVector(0,0), this.radius*2, this.a);
  this.control1 = posOnEllipse(new PVector(0,0), this.radius*4, this.radius, this.a);
  this.control2 = posOnEllipse(new PVector(0,0), this.radius*2, this.radius, -this.a);
  this.a += (TWO_PI/360)*3;
}
void showBeginEnd(){
